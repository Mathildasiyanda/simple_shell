...
/**
 * history_display - displays the history list with line numbers.
 * @shell_info: Structure containing potential arguments.
 * Return: Always 0
 */
int history_display(info_t *shell_info)
{
...
/**
 * alias_builtin - mimics the alias builtin.
 * @shell_info: Structure containing potential arguments.
 * Return: Always 0.
 */
int alias_builtin(info_t *shell_info)
{
	int i = 0;
	char *p = NULL;
	list_t *node = NULL;
